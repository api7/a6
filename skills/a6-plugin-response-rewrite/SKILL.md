...
description: >-
  Skill for configuring the Apache APISIX response-rewrite plugin via the a6 CLI.
  ...
  base64 body decoding, and common operational patterns.
version: "1.0.0"
...
- **Header manipulation order**: `add` → `remove` → `set` (same as proxy-rewrite).
