---
name: a6-plugin-ext-plugin
description: >-
  Skill for configuring the Apache APISIX external plugin system
  (ext-plugin-pre-req, ext-plugin-post-req, ext-plugin-post-resp) via the a6
